...
use Cafe\Models\FailedLogins;
use Cafe\Exception\Exception;
use Cafe\Models\SuccessLogins;
use Cafe\Models\RememberTokens;

/**
 * Manages Authentication/Identity Management in Cafe
 * Cafe\Auth\Auth
 * @package Cafe\Auth
 */
