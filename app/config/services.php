...
$di->set('dbOracle', function () {
    $config = $this->getConfig();
    return new OracleAdapter([
        'dbname' => $config->databaseOracle->dbname,
        'username' => $config->databaseOracle->username,
        'password' => $config->databaseOracle->password,
        'dialectClass' => $config->databaseOracle->dialectClass
    ]);
});
...
$di->set('dispatcher', function () {
    ...
    $dispatcher->setDefaultNamespace('Cafe\Controllers');
    return $dispatcher;
});
