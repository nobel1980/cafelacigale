...
use Phalcon\Tag;
use Cafe\Models\Profiles;
use Cafe\Forms\ProfilesForm;
use Phalcon\Mvc\Model\Criteria;
use Phalcon\Paginator\Adapter\Model as Paginator;

/**
 * CRUD to manage profiles
 * Cafe\Controllers\ProfilesController
...
class ProfilesController extends ControllerBase
{
    ...
    public function searchAction()
    {
        ...
        if ($this->request->isPost()) {
            $query = Criteria::fromInput($this->di, 'Cafe\Models\Profiles', $this->request->getPost());
